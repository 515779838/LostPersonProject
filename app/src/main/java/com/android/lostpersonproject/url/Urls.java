...
//    public final static String base_service = "http://show.huihaiedu.cn/base_service/";//演示环境，手机后台
//    public final static String base_service = "http://192.168.13.3/centsvc/";//测试环境，手机后台
    ...
    public final static String auth_login = base_url + "v1/auth/login";// 登录

    public final static String file_upload_url = base_url + "v1/auth/file_upload_url";// 上传文件

    public final static String getAppList = base_url + "v1/homePage/models_todoTasks";// 获取应用列表
