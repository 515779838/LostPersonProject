...
public class PersonDetailBean {
    ...
    public String toString() {
        return "PersonDetailBean{" +
                ...
                ", guardianOneCardId='" + guardianOneCardId + '\'' +
                ", guardianOneAddress='" + guardianOneAddress + '\'' +
                ", guardianOneTel='" + guardianOneTel + '\'' +
                ", guardianTwo='" + guardianTwo + '\'' +
                ", relationTwo='" + relationTwo + '\'' +
                ", guardianTwoCardId='" + guardianTwoCardId + '\'' +
                ", guardianTwoAddress='" + guardianTwoAddress + '\'' +
                ", guardianTwoTel='" + guardianTwoTel + '\'' +
                ", policeStationId='" + policeStationId + '\'' +
                ", localPoliceStationId='" + localPoliceStationId + '\'' +
                ", responsibilityAreaId='" + responsibilityAreaId + '\'' +
                ", portrait_nav='" + portrait_nav + '\'' +
